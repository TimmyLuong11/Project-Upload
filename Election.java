...
public class Election 
{
	...
	private static void singleDonorDetails(Scanner keyboard, Campaign candidate)
	{
		...
		System.out.println("Enter the name of the donor:");
	    String name = keyboard.nextLine();
	    for(int index = 0; index < candidate.donors.size(); ++index)
	    {
	      Donor d = candidate.donors.get(index);
	      if(d.getName().equals(name))
	      {
	        System.out.println("Name of donor: " + d.getName());
	        System.out.println("Total donations: " + d.getTotalDonations());
	        System.out.print("List of donations from the donor: " + d.toString());
	      }
	      else
	      {
