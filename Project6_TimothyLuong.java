 ...
 *
 */
public class Project6_TimothyLuong
{
	...
	public static void main(String[] args) throws FileNotFoundException
	{
		...
		while (repeatPlay.equalsIgnoreCase("yes"))
		{
			...
			String scrambledWord = mixingLetters(chosenWord);
			boolean won = guessedCorrectly(keyboard, scrambledWord, chosenWord);
	...
	public static String chooseRandomWordFromDictionary() throws FileNotFoundException
	{
		...
		// The format of the dictionary file is the number of words in the dictionary, followed by the words, one to a line
		int wordsInDictionary = dictionary.nextInt(); // Get the number of words out of the file.
	...
	public static String mixingLetters(String chosenWord)
	{
	...
	public static boolean guessedCorrectly(Scanner keyboard, String scrambledWord, String chosenWord)
	{	
		final int TRIES = 3;	
